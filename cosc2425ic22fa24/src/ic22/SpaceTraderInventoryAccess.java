...
public class SpaceTraderInventoryAccess {

    public static void main(String[] args) {

        // Number of trade goods to create
        int numItems = 10000; // Start with 10,000, test with 100,000 and 1,000,000 later
        ...
        // Access and potentially remove a large number of trade goods from ArrayList
        for (int i = 0; i < numItems; i++) {
            TradeGood good = arrayListInventory.get(i); // Access
            // Example operation: Update quantity
            good.quantity = good.quantity + 1; // Modify quantity directly without getters/setters
        }
        ...
        long arrayListTime = endTimeAL - startTime;
        ...
        // Access and potentially remove a large number of trade goods from LinkedList
        for (int i = 0; i < numItems; i++) {
            TradeGood good = linkedListInventory.get(i); // Access
            // Example operation: Update quantity
            good.quantity = good.quantity + 1; // Modify quantity directly without getters/setters
        }
